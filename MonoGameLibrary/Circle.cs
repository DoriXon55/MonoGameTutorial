...
public readonly struct Circle : IEquatable<Circle>
{
    ...
    /// <summary>
    ///  Location of center of this circle
    /// </summary>
    ...
    /// <summary>
    /// Gets a value thtat indicates whether this circle has a radius of 0 and location of (0,0)
    /// </summary>
    public readonly bool IsEmpty => X == 0 && Y == 0 && Radius == 0;

    /// <summary>
    /// Gets the y-coordinate of the higest point on this circle
    /// </summary>
